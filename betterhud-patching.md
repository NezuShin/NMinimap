...
- Set `enable-1-21-11: false` and `enable-26-1: false` in NMinimap's config.yml
- Reload NMinimap and BetterHud
- Merge resourcepacks. You may use [PackMerger](https://www.spigotmc.org/resources/packmerger.132700/),
[Resource Pack Manager](https://www.spigotmc.org/resources/resource-pack-manager.118574/) or any another solution.
Or even do it by hands 
